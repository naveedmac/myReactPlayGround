...
console.log(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* default */](5 , 6 ));
console.log(`He is an adult:${__WEBPACK_IMPORTED_MODULE_1__person__["c" /* isAdult */](19)}`);
console.log(`He  can eat:${__WEBPACK_IMPORTED_MODULE_1__person__["a" /* canEat */](0)}`);
console.log(`He  is Senior:${__WEBPACK_IMPORTED_MODULE_1__person__["b" /* default */](65)}`);
...
const canEat =(age)=> age >= 1 ;
/* harmony export (immutable) */ __webpack_exports__["a"] = canEat;
